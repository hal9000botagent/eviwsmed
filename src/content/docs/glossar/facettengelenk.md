---
title: Facettengelenk
description: Anatomie und Funktion der Facettengelenke der Wirbelsäule
sidebar:
...
Jedes Facettengelenk wird gebildet aus dem unteren Gelenkfortsatz (Processus articularis inferior) des oberen Wirbels und dem oberen Gelenkfortsatz (Processus articularis superior) des darunterliegenden Wirbels. Die Gelenkflächen sind mit hyalinem Knorpel überzogen und von einer Gelenkkapsel umschlossen, die Synovialflüssigkeit enthält.

Die Ausrichtung der Gelenkflächen unterscheidet sich je nach Wirbelsäulenabschnitt:

- **HWS:** Nahezu horizontale Stellung → ermöglicht große Rotations- und Seitneigungsbewegungen.
- **BWS:** Frontal ausgerichtet → begrenzt Flexion/Extension, erlaubt Rotation.
- **LWS:** Sagittal ausgerichtet → erlaubt Flexion/Extension, begrenzt Rotation.

Die Facettengelenke sind durch den Ramus medialis des Ramus dorsalis des Spinalnervs innerviert. Jedes Gelenk wird von mindestens zwei segmentalen Nerven versorgt.
