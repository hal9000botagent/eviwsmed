---
title: Rückenmark
description: Anatomie und Funktion des Rückenmarks (Medulla spinalis)
sidebar:
  label: Rückenmark
  order: 6
---
...
Das Rückenmark ist ein zylindrischer Strang von etwa 40–45 cm Länge und einem Durchmesser von ca. 1 cm. Es weist zwei Verdickungen auf:

- **Intumescentia cervicalis (C4–Th1):** Versorgt die obere Extremität über den Plexus brachialis.
- **Intumescentia lumbosacralis (L2–S3):** Versorgt die untere Extremität über den Plexus lumbosacralis.

Im Querschnitt gliedert sich das Rückenmark in:

- **Graue Substanz (innen):** Schmetterlingsförmig angeordnete Nervenzellkörper. Das Vorderhorn enthält Motoneurone, das Hinterhorn verarbeitet sensible Informationen, das Seitenhorn (thorakal) beherbergt vegetative Neurone.
- **Weiße Substanz (außen):** Auf- und absteigende Nervenfaserbahnen (Tractus), die Informationen zwischen Gehirn und Peripherie leiten.

Das Rückenmark ist von drei Hirnhäuten umgeben (Dura mater, Arachnoidea, Pia mater). Im Subarachnoidalraum zirkuliert der Liquor cerebrospinalis, der als Schutzpolster dient.
